...
echo sprintf( __( "Hi there. Your recent order on %s is out for delivery. Your order details are shown below for your reference:", 'woocommerce' ), get_option( 'blogname' ) ) . "\n\n";
